...
def afiliado_pdf(request, afiliado_id):
    ...
    pdf.multi_cell(0,10,'',0, 'J')
    pdf.multi_cell(0,10,f'La Junta De Accion Comunal BARRIO PABLO SEXTO del municipio de Acacias - Meta, a solicitud del interesado informa que el(la) Señor(a) {NombreMayus}, identificado(a) con la cédula de ciudadania número {afiliados.numero_documento} está afiliado(a) a esta Organización de Acción Comunal desde el {afiliados.created}, en el folio 2 con el número de registro 2 del libro de afiliados.',0, 'J')
    pdf.multi_cell(0,10,'',0, 'J')
    pdf.multi_cell(0,10,f'Se expide en el municipio de Acacias el día {now.day} de {now.month} de {now.year}. Puede verificar la autenticidad de este documento ingresando a la pagina web http://orso.meta.gov.co en la sección de trámites en línea y digitar el siguiente código: 0DBet7JfHWLBdcq',0, 'J')
    pdf.multi_cell(0,10,'',0, 'J')
    pdf.multi_cell(0,10,'',0, 'J')
    pdf.multi_cell(0,10,'',0, 'J')
    pdf.multi_cell(0,10,'',0, 'J')
